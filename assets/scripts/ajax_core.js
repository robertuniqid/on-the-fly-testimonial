...
AjaxFramework.Client	=	function()
{
  ...
  this.responseObjectSpace	=	null;

  this.setData = function(xData, serilized)
  {
    if(typeof serilized == "undefined" && serilized != true)
  ...
  {
    this.responseErrorCallBack	=	yCallBack;
  };
  ...
  this.setResponseObjectSpace	=	function(object_space)
  {
    this.responseObjectSpace	=	object_space;
  };
  ...
  this.Run	= function()
  {
    ...
    if(this.responseObjectSpace == null)
      this.responseObjectSpace = this;
    ...
    try{
      ...
      request.fail( $.proxy(this.responseErrorCallBack, this.responseObjectSpace) );
      request.done( $.proxy(this.responseOKCallBack, this.responseObjectSpace));
